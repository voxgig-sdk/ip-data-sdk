...
from projectname_sdk.core.control import IpDataControl
...
class IpDataContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(rp, IpDataResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return IpDataError(code, msg, self)
