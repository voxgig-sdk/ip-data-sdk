...
from projectname_sdk import IpDataSDK
from projectname_sdk.core.spec import IpDataSpec
from projectname_sdk.core.result import IpDataResult
from projectname_sdk.core.response import IpDataResponse
from projectname_sdk.core.operation import IpDataOperation
from projectname_sdk.core.error import IpDataError
from projectname_sdk.core import helpers
from projectname_sdk.feature.base_feature import IpDataBaseFeature
...
class TestPrimaryUtility:
    ...
    def test_feature_init_basic(self):
        init_client = IpDataSDK.test(None, None)
        ...
        class TestInitFeature(IpDataBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(IpDataBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = IpDataSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = IpDataSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = IpDataSDK.test(None, setup_opts)
