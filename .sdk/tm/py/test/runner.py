...
class IpDataTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = IpDataTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = IpDataTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = IpDataTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
