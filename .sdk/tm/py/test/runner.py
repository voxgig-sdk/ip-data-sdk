...
class IpDataTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = IpDataTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = IpDataTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = IpDataTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
