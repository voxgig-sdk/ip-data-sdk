...
// IpData SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class IpDataMakeRequest
{
    public static function call(IpDataContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new IpDataResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new IpDataResponse($fetched);
        } else {
