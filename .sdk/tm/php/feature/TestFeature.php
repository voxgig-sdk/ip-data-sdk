...
// IpData SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class IpDataTestFeature extends IpDataBaseFeature
{
    ...
    public function init(IpDataContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (IpDataContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (IpDataContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(IpDataContext $ctx, $op, $args): array
    {
