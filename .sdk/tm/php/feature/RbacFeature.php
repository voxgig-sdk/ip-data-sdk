...
class IpDataRbacFeature extends IpDataBaseFeature
{
    ...
    private function _required(IpDataContext $ctx): ?string
    {
    ...
    private function _reject(IpDataContext $ctx, string $required): void
    {
    ...
    private function _track(IpDataContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
