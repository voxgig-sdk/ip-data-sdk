...
class IpDataStreamingFeature extends IpDataBaseFeature
{
    ...
    private function _iterate(IpDataResult $result): \Generator
    {
    ...
    private function _streamable(IpDataContext $ctx): bool
    {
