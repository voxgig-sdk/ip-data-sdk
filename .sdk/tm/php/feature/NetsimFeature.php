...
class IpDataNetsimFeature extends IpDataBaseFeature
{
    ...
    private function _simulate(IpDataContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(IpDataContext $ctx, array $applied): void
    {
        $client = $this->client;
