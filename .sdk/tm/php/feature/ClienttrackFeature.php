...
// IpData SDK clienttrack feature
...
class IpDataClienttrackFeature extends IpDataBaseFeature
{
    ...
    public function PostConstruct(IpDataContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'IpData-SDK';
