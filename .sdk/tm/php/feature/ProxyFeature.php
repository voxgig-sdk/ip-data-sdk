...
class IpDataProxyFeature extends IpDataBaseFeature
{
    ...
    public function init(IpDataContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (IpDataContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
