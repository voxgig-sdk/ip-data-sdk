...
|---|---|---|
| `ts/` | @voxgig-sdk/ip-data-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/ip-data-sdk \
      --repository voxgig-sdk/ip-data-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/ip-data-sdk` shows it, and
`npm trust revoke @voxgig-sdk/ip-data-sdk --id=<id>` removes it.
