...
func registerSDKWords(r *eng.Registry, client *sdk.IpDataSDK) {
...
func runOp(client *sdk.IpDataSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
