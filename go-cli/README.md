...
AQL-driven CLI and REPL for the IpData SDK. Positional arguments are
...
./ip-data-cli list get_ip_info
./ip-data-cli load 1 get_ip_info
./ip-data-cli load '{id:1}' get_ip_info
