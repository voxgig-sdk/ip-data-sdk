...
from ipdata_sdk.utility import register

# Load features
from ipdata_sdk.feature.base_feature import IpDataBaseFeature
from ipdata_sdk.features import _has_feature, _make_feature
...
class IpDataSDK:
    ...
    def get_utility(self):
        return IpDataUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("IpDataSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def GetIpInfo(self, data=None) -> "GetIpInfoEntity":
        ...
        from ipdata_sdk.entity.get_ip_info_entity import GetIpInfoEntity
        return GetIpInfoEntity(self, data)



    @classmethod
    def test(cls, testopts=None, sdkopts=None) -> "IpDataSDK":
        if sdkopts is None:
            sdkopts = {}
