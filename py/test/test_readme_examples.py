# IpData SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions IpDataSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both IpDataSDK(...) and IpDataSDK.test(...) become
#      IpDataSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "ipdata_sdk"
_SDK_CLASS = "IpDataSDK"
