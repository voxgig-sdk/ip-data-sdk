...
class IpDataTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = IpDataTestRunner.getenv("IPDATA_TEST_LIVE")
        override = IpDataTestRunner.getenv("IPDATA_TEST_OVERRIDE")
        ...
        explain = IpDataTestRunner.getenv("IPDATA_TEST_EXPLAIN")
        if explain is not None and explain != "":
            m["IPDATA_TEST_EXPLAIN"] = explain
