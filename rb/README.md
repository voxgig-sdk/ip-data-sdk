...
The Ruby SDK for the IpData API — an entity-oriented client using idiomatic Ruby conventions.
...
raise a `IpDataError` (a `StandardError` subclass), so wrap
