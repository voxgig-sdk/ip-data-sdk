...
IpDataSDK._make_feature = _make_feature


function IpDataSDK.new(options)
  local self = setmetatable({}, IpDataSDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function IpDataSDK:options_map()
...
function IpDataSDK:get_utility()
  return Utility.copy(self._utility)
end


function IpDataSDK:get_root_ctx()
  return self._rootctx
end


function IpDataSDK:prepare(fetchargs)
...
function IpDataSDK:direct(fetchargs)
...
-- by passing it.
function IpDataSDK:_raw_request(fetchargs)
  local utility = self._utility
...
function IpDataSDK:graphql(query, variables, ctrl)
...
function IpDataSDK:GetIpInfo(data)
...
function IpDataSDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}
  ...
  local sdk = IpDataSDK.new(sdkopts)
  sdk.mode = "test"
