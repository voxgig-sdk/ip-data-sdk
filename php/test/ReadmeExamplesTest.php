...
// IpData SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (IpDataSDK::test)
...
{
    private const SDK_CLASS = 'IpDataSDK';
    ...
    private const SDK_BASE = 'ipdata_sdk';
