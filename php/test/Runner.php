...
class IpDataTestRunner
{
    ...
    {
        $live = self::getenv('IP_DATA_TEST_LIVE');
        $override = self::getenv('IP_DATA_TEST_OVERRIDE');
        ...
        $explain = self::getenv('IP_DATA_TEST_EXPLAIN');
...
class_alias('IpDataTestRunner', 'Runner');
class_alias('IpDataHelpers', 'Helpers');
