...
class IpDataFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; IpDataSDK/1.0)';
    ...
    public static function call(IpDataContext $ctx, string $fullurl, array $fetchdef): array
    {
