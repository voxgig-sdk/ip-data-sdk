...
class IpDataCacheFeature extends IpDataBaseFeature
{
    ...
    private function _through(IpDataContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
