...
class IpDataRatelimitFeature extends IpDataBaseFeature
{
    ...
    private function _acquire(IpDataContext $ctx): void
    {
    ...
    private function _track(IpDataContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
