...
class IpDataTimeoutFeature extends IpDataBaseFeature
{
    ...
    private function _with_timeout(IpDataContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(IpDataContext $_ctx, float $ms): void
    {
        $client = $this->client;
