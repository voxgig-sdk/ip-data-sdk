# IpData Golang SDK Reference

Complete API reference for the IpData Golang SDK.
...
#### `TestSDK(testopts, sdkopts map[string]any) *IpDataSDK`
...
#### `GetIpInfo(data map[string]any) IpDataEntity`
