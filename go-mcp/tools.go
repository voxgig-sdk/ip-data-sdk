...
func registerTools(server *mcp.Server, client *sdk.IpDataSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "ip-data_list",
		Description: "List records from IpData. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "ip-data_load",
		Description: "Load a single record from IpData. " +
...
func runOp(client *sdk.IpDataSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.IpDataSDK, name string) (sdk.IpDataEntity, error) {
