...
function envOverride(m) {
    if ('TRUE' === process.env.IP_DATA_TEST_LIVE ||
        'TRUE' === process.env.IP_DATA_TEST_OVERRIDE) {
    ...
    m.IP_DATA_TEST_EXPLAIN = process.env.IP_DATA_TEST_EXPLAIN || m.IP_DATA_TEST_EXPLAIN;
    return m;
}
