...
function liveScenariosActive() { return false && process.env.IP_DATA_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.IpDataSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
            apikey: env.IP_DATA_APIKEY,
        }));
        let idmap = env['IP_DATA_TEST_GET_IP_INFO_ENTID'];
    ...
    const client = new __1.IpDataSDK({
        base: 'http://localhost:8080',
