...
(0, node_test_1.describe)('GetIpInfoEntity', async () => {
    ...
    (0, node_test_1.afterEach)((0, utility_1.liveDelay)('IP_DATA_TEST_LIVE'));
    (0, node_test_1.test)('instance', async () => {
        const testsdk = __1.IpDataSDK.test();
...
function basicSetup(extra) {
    ...
    let client = __1.IpDataSDK.test(options, extra);
    ...
    if (live) {
        ...
        client = new __1.IpDataSDK(merge([
