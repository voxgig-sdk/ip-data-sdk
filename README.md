...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/ip-data` | `npm install @voxgig-sdk/ip-data` |
| Python | `voxgig-sdk-ip-data` | `pip install voxgig-sdk-ip-data` |
| PHP | `voxgig-sdk/ip-data` | `composer require voxgig-sdk/ip-data` |
| Golang | `github.com/voxgig-sdk/ip-data-sdk/go` | `go get github.com/voxgig-sdk/ip-data-sdk/go` |
| Ruby | `voxgig-sdk-ip-data` | `gem install voxgig-sdk-ip-data` |
| Lua | `voxgig-sdk-ip-data` | `luarocks install voxgig-sdk-ip-data` |
